-- =============================================================================
-- AquaDealer Conditional Cash Book
-- Migration 022: Update payment RPCs to only insert into cash_book when method is cash
-- =============================================================================
...
BEGIN
  ...
  IF COALESCE(p_payload->>'method', 'cash') = 'cash' THEN
    INSERT INTO cash_book (
      dealer_id,
      branch_id,
      entry_type,
