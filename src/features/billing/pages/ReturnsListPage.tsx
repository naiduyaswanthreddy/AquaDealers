...
export const ReturnReview: React.FC<{ preview: FarmerReturnPreview; receivingBranch: string; settlementMethod: 'farmer_credit' | 'cash_refund'; setSettlementMethod: (method: 'farmer_credit' | 'cash_refund') => void }> = ({ preview, receivingBranch, settlementMethod, setSettlementMethod }) =><div className="grid gap-4 text-sm">
