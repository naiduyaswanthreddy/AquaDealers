                  ...
                  <td className="p-2">
                    <div className="relative">
                      ...
                      <input
                        ...
                        className="w-full pl-9 pr-3 py-2 bg-white border border-slate-200 rounded-lg text-sm focus:ring-2 focus:ring-brand-500 focus:border-brand-500 transition-shadow outline-none"
                      />
                    </div>
                  </td>
                  <td className="p-2">
